...
{
    public class ModalPhoneUnlockViewComponent : ViewComponent
    {
        ...
        public ModalPhoneUnlockViewComponent(IBrandService brandService,
            ...
            SignInManager<User> signInManager,IWorkContext workContext)
        {
        ...
        {
            var currentuser = workContext.GetCurrentUserAsync().Result;
            int countryid = 0;
            if (currentuser.CountryId != null)
            {
                countryid = currentuser.CountryId.Value;
